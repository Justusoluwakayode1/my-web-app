        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-foreground">BuildCorp Materials</h1>
                <p className="text-sm text-muted-foreground">Industrial Building Solutions</p>
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-6 text-sm">
              ...
              <div className="flex items-center space-x-2 text-muted-foreground">
                ...
                <span>quotes@buildcorp.com</span>
              </div>
              <div className="flex items-center space-x-2 text-muted-foreground">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto fade-in-up animate">
          <div className="inline-flex items-center space-x-2 bg-accent/20 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-accent font-medium">30+ Years Building Excellence</span>
          </div>
